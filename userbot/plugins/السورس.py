...
async def _(event):
    ...
    OUTPUT = (f"☭︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس الوالي @rxoxx :**\n\n{o}")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**☭︙  📑 يرجى متابع قناه السورس تجدها هنا : @rxoxx")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**☭︙ قـائمـه الاوامـر :**\n**☭︙ قنـاه السـورس :** @rxoxx\n**☭︙ شـرح اوامـر السـورس : @rxoxx**\n**☭︙ شـرح فـارات السـورس : @rxoxx** "
